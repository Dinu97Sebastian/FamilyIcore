...
class AnnouncementUnReadFragment : Fragment(), AnnouncementAdapter.OnAnnouncementSelectedListener {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_unread_announcement, container, false)
        return root
    }
    ...
    private fun getUnReadAnnouncement() {
        ...
        compositeDisposable.add(
                requestInterface.getPost(requestBody).observeOn(AndroidSchedulers.mainThread())
                        ...
                        .subscribe({
                            hideShimmer()
                            if (it.body()?.unread_announcement!!.size > 0) {
                                announcement_refresh.visibility = View.VISIBLE
                                data.addAll(it.body()?.unread_announcement!!)
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(): AnnouncementUnReadFragment {
            return AnnouncementUnReadFragment().apply {
