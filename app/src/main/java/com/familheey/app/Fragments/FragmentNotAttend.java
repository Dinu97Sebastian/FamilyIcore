...
public class FragmentNotAttend extends Fragment {
    @BindView(R.id.count)
    TextView count;
    ...
    public static FragmentNotAttend newInstance(String eventId) {
        FragmentNotAttend fragment = new FragmentNotAttend();
    ...
    public void notattend(String query) {
        this.query = query;
        ...
        jsonObject.addProperty("rsvp_status", "not-going");
