...
public class FragmentAttending extends Fragment {
    ...
    public static FragmentAttending newInstance(String eventId) {
        FragmentAttending fragment = new FragmentAttending();
    ...
    public void attending(String query) {
        this.query = query;
        ...
        apiServiceProvider.goingGuestDetails(jsonObject, null, new RetrofitListener() {
            @Override
