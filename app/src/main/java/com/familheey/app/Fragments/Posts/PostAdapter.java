...
public class PostAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    PostAdapter(postItemClick mListener, Context context, List<PostData> data, PaginationAdapterCallback mCallback, String type, Boolean isAdmin,postRating mListener1) {
        this.repositories = data;
        this.context = context;
        this.isAdmin = isAdmin;
        this.mCallback = mCallback;
...
//                    });
                ...
                if (repositories.get(position).getRating_enabled()) {
                ...
                holderOne.txt_less_or_more.setOnClickListener(v -> {
                    ...
                    if (holderOne.txt_less_or_more.getText().equals("More")) {
                        ...
                        if(holderOne.txt_des!=null){
                            ...
                            /*String url = holderOne.txt_des.getText().toString();
                ...
                holderTwo.txt_temp.post(() -> {
                    ...
                    if (holderTwo.txt_temp.getLineCount() > 2) {
                        ...
                        if(holderTwo.txt_des!=null){
                            ...
                            /*String url = holderTwo.txt_des.getText().toString();
                            if (url.contains("blog.familheey.com")) {
                                // Dinu(09/11/2021) for open another app
                                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(url));
                                context.startActivity(intent);
...
//                        //  (megha,05/08/2021)for popup window
//                        View popupView = LayoutInflater.from(context).inflate(R.layout.popup_post_settings, null);
//                        final PopupWindow popupWindow = new PopupWindow(popupView, LinearLayout.LayoutParams.MATCH_PARENT, WindowManager.LayoutParams.WRAP_CONTENT);
//                        popupWindow.setOutsideTouchable(true);
//                        popupWindow.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.new_background_rounded));
//
//                        popupWindow.showAtLocation(popupView, Gravity.CENTER_VERTICAL, 0, 400);
                ...
                holderTwo.txt_less_or_more.setOnClickListener(v -> {
                    if (holderTwo.txt_less_or_more.getText().equals("More")) {
                        ...
                        if(holderTwo.txt_des!=null){
                            ...
                            String url1 = holderTwo.txt_des.getText().toString();
                            if (url1.contains("blog.familheey.com")) {
                                // Dinu(09/11/2021) for open another app
                                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(url1));
                                context.startActivity(intent);
                            }
                            else if (url1.contains("familheey")) {
                                openAppGetParams(url1);
                            }
...
//        ImageView settings;
        ...
        com.luseen.autolinklibrary.AutoLinkTextView auto_one;
...
//        ImageView settings;
        ...
        ImageView img_con;
        @BindView(R.id.txt_des)
        com.luseen.autolinklibrary.AutoLinkTextView auto_two;
