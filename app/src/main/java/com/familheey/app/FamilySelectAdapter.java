...
public class FamilySelectAdapter extends RecyclerView.Adapter<FamilySelectAdapter.ViewHolder> implements Filterable {
    ...
    public FamilySelectAdapter(List<Family> familyList, OnItemSelectedListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.btn_select.setOnClickListener(v -> {
            listener.onItemSelected(currentFamily);
        });
    }
    ...
    public interface OnItemSelectedListener {
        void onItemSelected(Family family);
