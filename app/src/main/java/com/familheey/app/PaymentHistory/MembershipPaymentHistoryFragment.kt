...
class MembershipPaymentHistoryFragment : Fragment(), ProgressListener, AllPaymentHistoryAdapter.ItemClick {
        ...
        compositeDisposable.add(
                requestInterface.getPaymentHistory(requestBody).observeOn(AndroidSchedulers.mainThread())
                        ...
                        .subscribe({
                            ...
                            payment_history_list.adapter = PaymentHistoryAdapter(it?.body()?.data, this)
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(sdate: String, edate: String, familyId: String?, userId: String?): MembershipPaymentHistoryFragment {
            return MembershipPaymentHistoryFragment().apply {
