...
class AllRequestPaymentHistoryAdapter(internal val items: List<Data>?, internal val listener: AllPaymentHistoryAdapter.ItemClick) : androidx.recyclerview.widget.RecyclerView.Adapter<AllRequestPaymentHistoryAdapter.ViewHolder>() {
